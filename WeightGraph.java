...
public class WeightGraph {
	...
	void printAllShortestDistances(String vert) throws Exception {
        ...
        // Your code here!
				...
				Map<Vertex<String>,Integer> cloud = ga.shortestPathLengths(sGraph,vSource);
				 // Find shortest path
				for(Entry<Vertex<String>,Integer> entry : cloud.entrySet()){
					/* Should print each entry
					*/
					System.out.println(vSource.getElement() +"="+ entry.getKey().getElement() +"="+ entry.getValue()  );
